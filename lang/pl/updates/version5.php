...
$string['warning3'] = 'This update requires that the /config directory is writeable.'; #niko
$string['warning4'] = 'Please chown the file to the webserver and chomod it 744'; #niko
