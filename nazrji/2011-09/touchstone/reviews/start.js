...
function openCalculator() {
  ...
  //} else {
    if (typeof(calc) == 'object' && calc.closed != true) {
      ...
      calc=window.open("../calc98/jcalc98.htm","calculator","width=250,height=331,top=10,left="+leftFigure+"scrollbars=no,resizable=no,toolbar=no,location=no,directories=no,status=no,menubar=no");
      if (window.focus) {
        calc.focus();
      }
    }
