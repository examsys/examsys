...
*/
  ...
  if ($paper_no == 1) {
    ...
    for ($i=0; $i<$paper_no; $i++) {
      echo "<tr><td width=\"66\" style=\"text-align:right\"><a href=\"" . $protocol . $_SERVER['HTTP_HOST'] . "/osce/class_list.php?osceID=" . $paper_display[$i]['id'] . "\"><img src=\"../touchstone/artwork/osce" . $shared . ".png\" width=\"48\" height=\"48\" alt=\"Type: OSCE Station\" border=\"0\" /></a></td>\n";
