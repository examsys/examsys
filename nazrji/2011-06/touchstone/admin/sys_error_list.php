...
<tr>
<td colspan="4" style="padding-left:0px; background-color:#F1F5FB"><div class="breadcrumb"><a href="../index.php">Home</a>&nbsp;&nbsp;<img src="../artwork/breadcrumb_arrow.png" width="4" height="7" alt="-" />&nbsp;&nbsp;<a href="./index.php">Administrative Tools</a></div><div style="margin-left:10px; font-size:200%; font-weight:bold">System Error Report</td>
<td colspan="3" style="padding-left:0px; background-color:#F1F5FB; text-align:right; vertical-align:top; padding-top:2px; padding-right:6px"><a href="#" onclick="launchHelp(1); return false;"><img src="../artwork/small_help_icon.gif" width="16" height="16" alt="Help" border="0" /></a><br /><div style="padding-top:5px"><input type="checkbox" name="showfixed" id="showfixed" value="1" onclick="updateCookies();"<?php if (isset($_COOKIE['showfixed'])) echo $_COOKIE['showfixed']; ?> /> Show fixed errors</div></td>
</tr>
