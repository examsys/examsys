...
Class ModuleUtils {
  ...
  static function addModules($moduleid, $fullname, $active, $school, $vle_api, $sms_api, $peer, $external, $stdset, $mapping, $db) {
    ...
    $result->bind_param('ssissss', $moduleid, $fullname, $active, $school, $vle_api, $tmp_checklist, $sms_api);
    $result->execute();
    $result->close();
    if($db->errno != 0) {
      return false;
