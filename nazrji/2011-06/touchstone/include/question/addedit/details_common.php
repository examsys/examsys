<tr>
              ...
              <td>
                <textarea id="theme" name="theme" cols="100" rows="5" class="form-large"><?php echo $question->theme ?></textarea>
            ...
            <tr>
              ...
              <td>
                <textarea id="notes" name="notes" cols="100" rows="2" class="form-large"><?php echo $question->notes ?></textarea>
            ...
            <tr>
              ...
              <td colspan="2">
                <?php echo wysiwyg_editor('edit_common1', 'scenario', $question->scenario); ?>
            ...
            <tr>
              ...
              <td>
                <?php echo wysiwyg_editor('edit_common2', 'leadin', $question->leadin); ?>
