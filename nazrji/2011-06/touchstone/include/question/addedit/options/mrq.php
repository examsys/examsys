...
?>
          <tbody class="option<?php echo $hidden ?>">
            <tr<?php echo $spaced ?>>
              <th<?php echo $spaced ?>><?php echo $mandatory ?><label for="option_text<?php echo $index ?>"><strong>Option <?php echo $index ?> Text</strong></label></th>
              <td<?php echo $spaced ?>>
              ...
              <td class="small"><input id="option_correct<?php echo $index ?>" name="option_correct" value="<?php echo $index ?>" type="checkbox"<?php echo $correct ?> /></td>
            </tr>
<?php
