...
class InstallUtils
{
    ...
    {
        // Categories.
        $insert = self::$db->prepare('INSERT INTO paper_settings_category VALUES ("security")');
        $insert->execute();
        $insert->close();

        // Setting declarations.
        $insert = self::$db->prepare('INSERT INTO paper_settings_setting VALUES ("remote_summative", "security", "boolean",
