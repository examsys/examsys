...
class gradebooktest extends unittestdatabase {
    ...
    public function getDataSet() {
        return new YamlDataSet($this->get_base_fixture_directory() . "gradebookTest" . DIRECTORY_SEPARATOR . "gradebook.yml");
    }
    /**
    ...
    public function get_expected_data_set($name) {
        return new YamlDataSet($this->get_base_fixture_directory() . "gradebookTest" . DIRECTORY_SEPARATOR . $name . ".yml");
    }
    /**
